                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{ asset('admin-lte/dist/img/avatar.png') }}">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{ asset('admin-lte/dist/img/avatar2.png') }}">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{ asset('admin-lte/dist/img/avatar3.png') }}">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{ asset('admin-lte/dist/img/avatar04.png') }}">
                              </li>
                          </ul>
                      </td>
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{ asset('admin-lte/dist/img/avatar5.png') }}">
                              </li>
                          </ul>
                      </td>
                      <td class="project_progress">
