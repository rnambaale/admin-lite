...
@push('extra-js')
    ...
    <!-- page script -->
    <script src="{{ asset('js/pages/ui_modals.js') }}"></script>
          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <h4 class="mt-4">Primary Navbar <small>(navbar-primary navbar-dark)</small></h4>
                ...
                <h4 class="mt-4">Orange Navbar <small>(navbar-orange navbar-light)</small></h4>
